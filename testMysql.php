...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>?action=test" id="mail" method="post">
	...
	<table cellpadding="2">
		<tr>
			<td>Hostname</td>
			<td><input type="text" name="hostname" id="hostname" value="127.0.0.1" size="30" tabindex="1" /></td>
		</tr>
		<tr>
			<td>Username</td>
			<td><input type="text" name="username" id="username" value="root" size="30" tabindex="2" /></td>
		</tr>
		<tr>
			<td>Password</td>
